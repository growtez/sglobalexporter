    ...
    <main className="flex flex-col min-h-screen bg-white font-sans w-full selection:bg-gold/25">
      ...
      <section className="w-full bg-white py-8 md:py-12 relative">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="bg-white dark:bg-stone-800/80 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100 dark:border-stone-700 grid grid-cols-2 lg:grid-cols-4 overflow-hidden mb-6">
            {/* Overall Rating */}
            <div className="col-span-1 lg:col-span-1 p-6 md:p-8 border-r border-b lg:border-b-0 border-gray-100 dark:border-stone-700 bg-gray-50/30 dark:bg-stone-900/30">
              <div className="flex items-center justify-center gap-2 mb-4 md:mb-6 text-amber-700 dark:text-amber-400 font-semibold text-xs md:text-sm uppercase tracking-wider">
                <Star className="w-4 h-4 fill-current" /> Overall Rating
              </div>
              <div className="flex flex-col items-center justify-center">
                <div className="text-4xl md:text-6xl font-black text-gray-900 dark:text-stone-100 mb-2 tracking-tighter">5.0<span className="text-xl md:text-3xl text-gray-300 dark:text-stone-600 font-medium tracking-normal">/5</span></div>
                <div className="flex gap-1 mb-3">
                  {[1, 2, 3, 4, 5].map(i => <Star key={i} className="w-4 h-4 md:w-6 md:h-6 text-yellow-400 fill-current drop-shadow-sm" />)}
                </div>
                <p className="text-[10px] md:text-sm text-gray-500 dark:text-stone-400 mb-4 md:mb-6 font-medium">Based on verified reviews</p>
                <Button variant="outline" className="border-gray-200 dark:border-stone-600 text-gray-700 dark:text-stone-300 dark:bg-stone-700/50 rounded-full h-8 md:h-10 px-4 md:px-6 text-[10px] md:text-sm font-semibold hover:bg-gray-50 hover:text-amber-700 shadow-sm">Write a Review</Button>
              </div>
            </div>

            {/* User Satisfaction */}
            <div className="col-span-1 lg:col-span-1 p-6 md:p-8 border-b lg:border-b-0 lg:border-r border-gray-100 dark:border-stone-700 bg-gray-50/30 dark:bg-stone-900/30 flex flex-col justify-center">
              <h3 className="text-xs md:text-sm font-semibold text-gray-800 dark:text-stone-200 uppercase tracking-wider mb-6 text-center">User Satisfaction</h3>
                ...
                {[
                  ...
                  return (
                    <div key={i} className="flex flex-row items-center gap-2.5 md:gap-4 w-full max-w-[150px] md:max-w-[180px] justify-start">
                      <div className="w-10 h-10 md:w-16 md:h-16 rounded-full bg-white dark:bg-stone-800 shadow-sm flex items-center justify-center text-[10px] md:text-sm font-extrabold text-stone-900 dark:text-stone-100 relative flex-shrink-0">
                        {metric.value}%
                        {/* Circle progress SVG */}
                      ...
                      <span className="text-[10px] md:text-sm text-stone-600 dark:text-stone-400 font-bold uppercase tracking-wide">{metric.label}</span>
                    </div>
                  );
                })}
              </div>
            ...
            {/* Individual Review */}
            <div className="col-span-2 lg:col-span-2 p-6 md:p-8 bg-white dark:bg-stone-800/50 flex flex-col justify-center">
                ...
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-1">
                    <div className="flex items-center gap-2">
                      <h4 className="font-bold text-gray-900 dark:text-stone-100 text-base md:text-lg">R.k. Aggarwal</h4>
                      <span className="px-2 py-0.5 bg-gray-100 dark:bg-stone-700 text-gray-500 dark:text-stone-400 rounded-md text-[10px] md:text-xs font-medium">Delhi</span>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] md:text-xs text-gray-400 dark:text-stone-500 font-medium">07 Jan 2025</span>
                    </div>
                  </div>
                  ...
                  <p className="text-gray-700 dark:text-stone-300 text-sm md:text-base leading-relaxed italic">"Refreshingly unique features that enhance usability and overall experience. Highly recommended for wholesale buyers."</p>
                </div>
              </div>
            </div>
          </div>
