...
export default function LoginPage() {
  ...
  return (
    <Suspense fallback={
      ...
      <LoginFormContent state={state} formAction={formAction} isPending={isPending} />
    </Suspense>
  );
}
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-10 shadow-sm border border-stone-200">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-stone-600">
            Or{" "}
            <Link href={redirectPath ? `/auth/register?redirect=${redirectPath}` : "/auth/register"} className="font-medium text-gold hover:text-gold/80 transition-colors">
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <Button
              type="button"
              variant="outline"
              className="w-full flex items-center justify-center gap-2 border-stone-200 hover:bg-stone-50 hover:text-stone-900"
              onClick={async () => {
